  ...
  return (
    <section>
      <div className="wrapper">
        <div className="py-12">
          {/* <h1 className='text-[17.25vw] font-semibold leading-[80%]'>ART & LIFE</h1> */}
          <svg
        ...
        <div className="bg-black p-5 gap-6 flex items-center">
        ...
        <div className="mt-[4.73rem] flex items-center gap-12">
          <h2 className="text-[6.5vw] font-semibold leading-[110%] uppercase text-black flex-1">
            Don’t close your eyes
          </h2>

          <div className="space-y-16 flex-1">
            <p className="text-lg leading-[180%] text-black">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="grid place-items-center text-xs uppercase py-2 px-3 border border-black rounded-full">
                Label
              </div>
            </div>
          </div>
        ...
        <div className="max-h-[45rem] overflow-hidden mt-12">
          <Image src={hero_banner} alt="hero banner" className="w-full h-full object-cover" style={{
